...
if vessl_on == True:
    ...
    import wandb
    wandb.login()
    wandb.init(project="second-eigen", name="strange manner TD3 architecture")
...
def main():
    ...
    hidden_size_Q = cfg.hidden_size_Q
    ...
    batch_size = int(os.environ.get("batch_size", 18))             # cfg.batch_siz
