...
def main():
    ...
    hidden_size_obs = int(os.environ.get("hidden_size_obs", 196))#cfg.hidden_size_obs       # GAT 해당(action 및 node representation의 hidden_size)
    hidden_size_comm = int(os.environ.get("hidden_size_comm", 196))#cfg.hidden_size_comm
    hidden_size_action = int(os.environ.get("hidden_size_action", 196))  # cfg.hidden_size_comm
