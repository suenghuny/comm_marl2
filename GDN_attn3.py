...
class Agent(nn.Module):
    def __init__(self,
        ...
        self.Q = Q_Attention(self.graph_embedding_comm + self.graph_embedding + n_representation_comm, self.n_representation_action, hidden_size_Q).to(device)
        self.Q_tar = Q_Attention(self.graph_embedding_comm + self.graph_embedding + n_representation_comm, self.n_representation_action, hidden_size_Q).to(device)
