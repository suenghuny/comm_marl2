...
def get_cfg():
    ...
    parser.add_argument("--hidden_size_obs", type=int, default=56, help="")
    parser.add_argument("--hidden_size_comm", type=int, default=56, help="")
    parser.add_argument("--hidden_size_action", type=int, default=56, help="")
    parser.add_argument("--n_representation_obs", type=int, default=48, help="")
    parser.add_argument("--n_representation_comm", type=int, default=48, help="")
