...
def get_cfg():
    ...
    parser.add_argument("--lr_min", type=float, default=2e-5, help="lr_min")
    parser.add_argument("--scheduler_step", type=int, default=3000, help="scheduler step")
    ...
    parser.add_argument("--map_name", type=str, default='MMM2', help="map name")
    parser.add_argument("--load", type=str, default='episode97000.pt', help="map name")
    parser.add_argument("--hidden_size_obs", type=int, default=84, help="")
    parser.add_argument("--hidden_size_comm", type=int, default=84, help="")
    parser.add_argument("--hidden_size_action", type=int, default=84, help="")
    parser.add_argument("--hidden_size_Q", type=int, default=128, help="")
    parser.add_argument("--n_representation_obs", type=int, default=48, help="")
    ...
    parser.add_argument("--graph_embedding", type=int, default=64, help="")
    parser.add_argument("--graph_embedding_comm", type=int, default=96, help="")
    ...
    parser.add_argument("--gamma1", type=float, default=0.5, help="")
    parser.add_argument("--gamma2", type=float, default=0.05, help="")
